...
EDUCATION_SECTIONS = [
    ...
    ("Strategies d'exploration", SECTION_COLOR, [
        ...
        "Heurist Controleur PD: flap si",
        "  sous porte ET pas en montee",
        "Guided  Gravity+Heuristique",
        "  = le meilleur combo!",
        "",
    ]),
    ("Parametres ajustables", SECTION_COLOR, [
        "Apprentissage:",
    ...
    ("Conseils", SECTION_COLOR, [
        ...
        "* Baissez epsilon quand les",
        "  Q-values commencent a varier",
        "* Augmentez penalite mort pour",
